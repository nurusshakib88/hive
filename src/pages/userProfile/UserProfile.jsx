...
const UserProfile = () => {
  ...
  useEffect(() => {
    ...
    setTotalPosts(posts.filter((post) => post.userId === isUser.userId).length);
  }, [posts, isUser]);
    ...
    <Container fluid>
      <div className="user-profile">
        {loading ? (
          ...
          <div className="profile-top">
            {isUser.photoURL && (
              <img
                src={isUser.photoURL}
                alt={`Profile of ${isUser.displayName}`}
              />
            )}
        ...
        {loading ? (
          ...
          <h3 className="pt-username">{isUser.displayName}'s Posts</h3>
        )}
        <div className="posts">
          {loading ? (
            ...
            posts
              .filter((post) => isUser.userId === post.userId)
              .map((post) => (
